...
// অরিজিনাল ফাইলের নাম দিয়ে নতুন সাউন্ড ইঞ্জিন
function playCaptureSound(capturedPieceName) {
    triggerVibration([100, 50, 100]); 
    
    let audioSrc = "sword.mp3"; // ডিফল্ট সাউন্ড (রাজা বা মন্ত্রীর জন্য)
    
    switch(capturedPieceName) {
        case "Ashva": 
            audioSrc = "scottishperson-sound-effect-horse-whinny-03-372258.mp3"; // ঘোড়ার ডাক
            break;
        case "Gaja": 
            audioSrc = "universfield-sad-trumpet-278822.mp3"; // হাতির ডাক (Trumpet)
            break;
        case "Ratha": 
            audioSrc = "freesound_community-slosh-a-101500.mp3"; // নৌকার মতো জলের শব্দ
            break;
        case "Padati": 
            audioSrc = "data_pion-st3-footstep-sfx-323056.mp3"; // পদাতিকের হাঁটার শব্দ
            break;
    }
...
function resetInitialSetup() {
    initialSetup = {
        ...
        "1-2": { name: "Padati", isWhite: false }, "1-3": { name: "Padati", isWhite: false }, 
        "1-4": { name: "Padati", isWhite: false }, "1-5": { name: "Padati", isWhite: false },
        "1-6": { name: "Padati", isWhite: false }, "1-7": { name: "Padati", isWhite: false },

        "6-0": { name: "Padati", isWhite: true }, "6-1": { name: "Padati", isWhite: true }, 
        "6-2": { name: "Padati", isWhite: true }, "6-3": { name: "Padati", isWhite: true }, 
        "6-4": { name: "Padati", isWhite: true }, "6-5": { name: "Padati", isWhite: true },
        "6-6": { name: "Padati", isWhite: true }, "6-7": { name: "Padati", isWhite: true },
        
        "7-0": { name: "Ratha", isWhite: true }, "7-1": { name: "Ashva", isWhite: true }, 
        "7-2": { name: "Gaja", isWhite: true },  "7-3": { name: "Mantri", isWhite: true },   
        "7-4": { name: "Raja", isWhite: true },  "7-5": { name: "Gaja", isWhite: true }, 
        "7-6": { name: "Ashva", isWhite: true }, "7-7": { name: "Ratha", isWhite: true }
    };
}
...
function triggerReset() {
    ...
    const historyFeed = document.getElementById('move-history-feed');
    if (historyFeed) {
        historyFeed.innerHTML = '<div class="text-stone-500 italic text-center mt-6">The battlefield awaits the first strike...</div>';
    }
