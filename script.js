...
function checkLegalMove(piece, fromR, fromC, toR, toC) {
    ...
    switch (piece.name) {
        case 'Padati':
            const dir = piece.isWhite ? -1 : 1;if (fromC === toC && toR === fromR + dir) return !target;
